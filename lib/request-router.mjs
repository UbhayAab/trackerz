...
//
// Two families live here. The IMPERATIVE one came first (change my plan, update
// my schedule) and the DECLARATIVE one was added on 2026-08-06, because people
// mostly do not phrase a plan change as a command - they state that something is
// now true of every day. The list carried the imperative form of change-my-diet
// but not the perfect form of diet-has-changed, so a real capture describing a
// permanent switch to whey and curd matched nothing, routed as a log, and had
// salvage turn the instruction itself into a 540 kcal meal that then ticked the
// very plan item it was asking to replace.
//
// Keep every entry quote-free of example prose: tests/mirror-parity extracts
// string literals from this array by regex and cannot tell a cue from a comment.
export const PLAN_CHANGE_CUES = [
  ...
  "for the next", "rest day", "make it a rest", "replace", "swap", "swap out", "swap my",
  ...
  // Declarative permanence markers - see the note above the array.
  "has changed", "have changed", "i now have", "i now eat", "i now do",
  "now i have", "now i eat", "now i do", "every single day", "every day now",
  "i've switched", "ive switched", "i have switched", "switched to",
  "these days i", "nowadays i", "my new breakfast", "my new lunch",
  "my new dinner", "my new routine", "my usual is now", "no longer eat",
  "no longer have", "stopped eating", "stopped having",
  // Hinglish equivalents of from-now-on and now-I.
  "ab se", "ab main", "ab mai",
];
