...
// NOTE for anyone extending this module: everything above the MIRROR END marker
// is copied BYTE-FOR-BYTE into supabase/functions/agent/index.ts and guarded by
// tests/spend-patterns-mirror.test.mjs. Re-exports and anything else the edge
// does not need belong HERE, below the marker, where they cost the mirror
// nothing. lib/pattern-engine.mjs consumes spTokens/spDice/spCircularMedian from
// this list rather than reimplementing them - a second Dice with a different
// stopword set would put the same meal in two clusters depending on which module
// asked.
export {
  ...
  spSingular, spIntersect, spSignedCircularDelta,
