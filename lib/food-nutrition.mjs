...
export const FOOD_TABLE = [
  ...
  // protein.
  { key: "paneer wrap", category: "fastfood", kind: "count", unit: "1 wrap", gramsPerUnit: 230, aliases: ["paneer wrap", "paneer roll", "paneer kathi roll"], calories: 500, protein_g: 17, carbs_g: 52, fat_g: 25 },
