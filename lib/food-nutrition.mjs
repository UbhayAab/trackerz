...
export const FOOD_TABLE = [
  ...
  { key: "soybean", category: "protein", kind: "gram", per: 100, unit: "100 g cooked", aliases: ["soybean", "soybeans", "soya bean", "soya beans", "soya", "soya chunks", "soy chunks", "soyabean", "soyabeans", "nutrela"], calories: 172, protein_g: 18, carbs_g: 10, fat_g: 9 },
