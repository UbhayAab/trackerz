...
export const FOOD_TABLE = [
  ...
  { key: "roti", kind: "count", unit: "1 roti", gramsPerUnit: 45, aliases: ["roti", "rotis", "phulka", "phulkas", "chapati", "chapatis", "chapathi", "fulka"], calories: 110, protein_g: 3.5, carbs_g: 22, fat_g: 1 },
  ...
  { key: "rice", kind: "count", unit: "1 katori", gramsPerUnit: 150, aliases: ["rice", "rice bowl", "steamed rice", "jeera rice", "white rice", "boiled rice", "chawal", "bhaat"], calories: 210, protein_g: 4, carbs_g: 45, fat_g: 0.5 },
  { key: "dal", kind: "count", unit: "1 katori", gramsPerUnit: 150, aliases: ["dal", "daal", "dal bowl", "lentils", "tadka dal", "dal fry"], calories: 150, protein_g: 9, carbs_g: 20, fat_g: 3 },
  { key: "sabzi", kind: "count", unit: "1 katori", gramsPerUnit: 150, aliases: ["sabzi", "sabji", "mixed veg", "veg curry", "bhindi", "aloo gobi"], calories: 130, protein_g: 4, carbs_g: 12, fat_g: 7 },
  { key: "rajma", kind: "count", unit: "1 katori", gramsPerUnit: 150, aliases: ["rajma", "kidney beans"], calories: 200, protein_g: 12, carbs_g: 30, fat_g: 4 },
  { key: "chole", kind: "count", unit: "1 katori", gramsPerUnit: 150, aliases: ["chole", "chana", "chickpea curry", "chana masala", "chhole"], calories: 220, protein_g: 11, carbs_g: 28, fat_g: 7 },
  { key: "sambar", kind: "count", unit: "1 katori", gramsPerUnit: 150, aliases: ["sambar", "sambhar"], calories: 140, protein_g: 6, carbs_g: 18, fat_g: 4 },
  { key: "curd", kind: "count", unit: "1 katori", gramsPerUnit: 150, mlPerUnit: 150, aliases: ["curd", "dahi", "yogurt", "yoghurt"], calories: 90, protein_g: 5, carbs_g: 6, fat_g: 5 },
  ...
  { key: "poha", kind: "count", unit: "1 plate", gramsPerUnit: 150, aliases: ["poha"], calories: 250, protein_g: 5, carbs_g: 40, fat_g: 7 },
  { key: "upma", kind: "count", unit: "1 katori", gramsPerUnit: 150, aliases: ["upma"], calories: 230, protein_g: 5, carbs_g: 35, fat_g: 8 },
  { key: "khichdi", kind: "count", unit: "1 bowl", gramsPerUnit: 250, aliases: ["khichdi"], calories: 290, protein_g: 11, carbs_g: 45, fat_g: 6 },
  ...
  { key: "chicken curry", kind: "count", unit: "1 katori", gramsPerUnit: 150, aliases: ["chicken curry", "chicken gravy", "butter chicken"], calories: 280, protein_g: 22, carbs_g: 6, fat_g: 18 },
  ...
  { key: "fish curry", kind: "count", unit: "1 katori", gramsPerUnit: 150, aliases: ["fish curry", "fish"], calories: 230, protein_g: 20, carbs_g: 5, fat_g: 14 },
  { key: "mutton curry", kind: "count", unit: "1 katori", gramsPerUnit: 150, aliases: ["mutton curry", "mutton", "lamb curry"], calories: 300, protein_g: 22, carbs_g: 5, fat_g: 22 },
  { key: "egg curry", kind: "count", unit: "1 katori (2 egg)", gramsPerUnit: 150, aliases: ["egg curry", "anda curry", "egg masala"], calories: 230, protein_g: 14, carbs_g: 6, fat_g: 16 },
  ...
  { key: "salad", kind: "count", unit: "1 bowl", gramsPerUnit: 250, aliases: ["salad", "salad bowl", "veg salad", "green salad"], calories: 150, protein_g: 5, carbs_g: 15, fat_g: 7 },
  { key: "fruit chaat", kind: "count", unit: "1 katori", gramsPerUnit: 150, aliases: ["fruit chaat", "fruit salad"], calories: 110, protein_g: 1.5, carbs_g: 26, fat_g: 0.5 },

  // --- drinks ---
  { key: "chai", kind: "count", unit: "1 cup", mlPerUnit: 150, aliases: ["chai", "tea", "masala chai", "milk tea", "doodh chai"], calories: 70, protein_g: 2, carbs_g: 8, fat_g: 3 },
  { key: "black tea", kind: "count", unit: "1 cup", mlPerUnit: 150, aliases: ["black tea", "green tea", "lemon tea"], calories: 5, protein_g: 0, carbs_g: 1, fat_g: 0 },
  { key: "coffee", kind: "count", unit: "1 cup", mlPerUnit: 150, aliases: ["coffee", "milk coffee", "cappuccino", "latte", "cafe latte"], calories: 60, protein_g: 2, carbs_g: 7, fat_g: 3 },
  { key: "black coffee", kind: "count", unit: "1 cup", mlPerUnit: 150, aliases: ["black coffee", "americano", "espresso"], calories: 5, protein_g: 0.3, carbs_g: 1, fat_g: 0 },
  { key: "filter coffee", kind: "count", unit: "1 cup", mlPerUnit: 150, aliases: ["filter coffee", "south indian coffee"], calories: 90, protein_g: 3, carbs_g: 9, fat_g: 4 },
  { key: "milk", kind: "ml", per: 250, unit: "1 glass (250 ml)", aliases: ["milk", "toned milk", "doodh"], calories: 140, protein_g: 8, carbs_g: 12, fat_g: 5 },
  { key: "lassi", kind: "count", unit: "1 glass", mlPerUnit: 250, aliases: ["lassi", "sweet lassi"], calories: 220, protein_g: 7, carbs_g: 28, fat_g: 8 },
  { key: "buttermilk", kind: "count", unit: "1 glass", mlPerUnit: 250, aliases: ["buttermilk", "chaas", "chhaas"], calories: 60, protein_g: 3, carbs_g: 6, fat_g: 2 },
  { key: "juice", kind: "count", unit: "1 glass", mlPerUnit: 250, aliases: ["juice", "orange juice", "fruit juice", "mango juice"], calories: 130, protein_g: 1, carbs_g: 32, fat_g: 0.3 },
  ...
  { key: "diet soft drink", kind: "count", unit: "1 can", aliases: ["diet coke", "coke zero", "coca cola zero", "diet pepsi", "pepsi black", "pepsi zero", "sprite zero", "thums up zero", "zero sugar cola", "sugar free cola", "diet soda", "diet soft drink"], calories: 2, protein_g: 0, carbs_g: 0.5, fat_g: 0 },
  { key: "protein shake", kind: "count", unit: "1 glass", mlPerUnit: 300, aliases: ["protein shake", "protein milk shake", "mass gainer shake"], calories: 250, protein_g: 35, carbs_g: 12, fat_g: 5 },
  ...
  { key: "blueberry", kind: "gram", per: 100, unit: "100 g", aliases: ["blueberry", "blueberries"], calories: 57, protein_g: 0.7, carbs_g: 14, fat_g: 0.3 },
  ...
  { key: "millet chips", kind: "gram", per: 55, unit: "1 pack (55 g)", aliases: ["ragi chips", "millet chips", "ragi chip", "millet chip", "baked chips"], calories: 250, protein_g: 4.5, carbs_g: 33, fat_g: 11 },
  ...
  { key: "popcorn", kind: "gram", per: 100, unit: "100 g", aliases: ["popcorn", "cheese popcorn", "caramel popcorn"], calories: 500, protein_g: 8, carbs_g: 57, fat_g: 27 },
  { key: "burrito", kind: "count", unit: "1 regular", aliases: ["burrito", "burritos"], calories: 900, protein_g: 30, carbs_g: 110, fat_g: 38 },
  { key: "nachos", kind: "gram", per: 100, unit: "100 g", aliases: ["nachos", "nacho"], calories: 490, protein_g: 8, carbs_g: 58, fat_g: 25 },
  { key: "quesadilla", kind: "count", unit: "1 piece", aliases: ["quesadilla", "quesadillas"], calories: 520, protein_g: 22, carbs_g: 40, fat_g: 29 },
